...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.dogsOwnersAnwer.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.dogs-owners-anwers.update", [$dogsOwnersAnwer->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="name">{{ trans('cruds.dogsOwnersAnwer.fields.name') }}</label>
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $dogsOwnersAnwer->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="text" name="email" id="email" value="{{ old('email', $dogsOwnersAnwer->email) }}" required>
                @if($errors->has('email'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('department') ? 'is-invalid' : '' }}" name="department_id" id="department_id" required>
                    @foreach($departments as $id => $department)
                        <option value="{{ $id }}" {{ (old('department_id') ? old('department_id') : $dogsOwnersAnwer->department->id ?? '') == $id ? 'selected' : '' }}>{{ $department }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('city') ? 'is-invalid' : '' }}" name="city_id" id="city_id" required>
                    @foreach($cities as $id => $city)
                        <option value="{{ $id }}" {{ (old('city_id') ? old('city_id') : $dogsOwnersAnwer->city->id ?? '') == $id ? 'selected' : '' }}>{{ $city }}</option>
                    @endforeach
                </select>
                @if($errors->has('city'))
            ...
            <div class="form-group">
                ...
                @foreach(App\DogsOwnersAnwer::DOG_APPEAR_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('dog_appear') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="dog_appear_{{ $key }}" name="dog_appear" value="{{ $key }}" {{ old('dog_appear', $dogsOwnersAnwer->dog_appear) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('other_1') ? 'is-invalid' : '' }}" type="text" name="other_1" id="other_1" value="{{ old('other_1', $dogsOwnersAnwer->other_1) }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\DogsOwnersAnwer::DOG_CONSIDERATION_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('dog_consideration') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="dog_consideration_{{ $key }}" name="dog_consideration" value="{{ $key }}" {{ old('dog_consideration', $dogsOwnersAnwer->dog_consideration) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('other_2') ? 'is-invalid' : '' }}" type="text" name="other_2" id="other_2" value="{{ old('other_2', $dogsOwnersAnwer->other_2) }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\DogsOwnersAnwer::DOG_FOOD_ADVICE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('dog_food_advice') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="dog_food_advice_{{ $key }}" name="dog_food_advice" value="{{ $key }}" {{ old('dog_food_advice', $dogsOwnersAnwer->dog_food_advice) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                @foreach(App\DogsOwnersAnwer::DOG_FOOD_CHOOSE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('dog_food_choose') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="dog_food_choose_{{ $key }}" name="dog_food_choose" value="{{ $key }}" {{ old('dog_food_choose', $dogsOwnersAnwer->dog_food_choose) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('other_4') ? 'is-invalid' : '' }}" type="text" name="other_4" id="other_4" value="{{ old('other_4', $dogsOwnersAnwer->other_4) }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\DogsOwnersAnwer::DOG_DIFF_NUTRITION_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('dog_diff_nutrition') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="dog_diff_nutrition_{{ $key }}" name="dog_diff_nutrition" value="{{ $key }}" {{ old('dog_diff_nutrition', $dogsOwnersAnwer->dog_diff_nutrition) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                @foreach(App\DogsOwnersAnwer::DOG_DIET_OWNER_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('dog_diet_owner') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="dog_diet_owner_{{ $key }}" name="dog_diet_owner" value="{{ $key }}" {{ old('dog_diet_owner', $dogsOwnersAnwer->dog_diet_owner) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                @foreach(App\DogsOwnersAnwer::DOG_FOOD_TYPE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('dog_food_type') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="dog_food_type_{{ $key }}" name="dog_food_type" value="{{ $key }}" {{ old('dog_food_type', $dogsOwnersAnwer->dog_food_type) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('diamond_naturals_8') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="diamond_naturals_8" id="diamond_naturals_8" value="1" {{ $dogsOwnersAnwer->diamond_naturals_8 || old('diamond_naturals_8', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('purina_8') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="purina_8" id="purina_8" value="1" {{ $dogsOwnersAnwer->purina_8 || old('purina_8', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('hills_8') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="hills_8" id="hills_8" value="1" {{ $dogsOwnersAnwer->hills_8 || old('hills_8', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('pedigree_8') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="pedigree_8" id="pedigree_8" value="1" {{ $dogsOwnersAnwer->pedigree_8 || old('pedigree_8', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('royal_canin_8') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="royal_canin_8" id="royal_canin_8" value="1" {{ $dogsOwnersAnwer->royal_canin_8 || old('royal_canin_8', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('mars_8') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="mars_8" id="mars_8" value="1" {{ $dogsOwnersAnwer->mars_8 || old('mars_8', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('other_8') ? 'is-invalid' : '' }}" type="text" name="other_8" id="other_8" value="{{ old('other_8', $dogsOwnersAnwer->other_8) }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\DogsOwnersAnwer::DOG_PERCENT_CONCENTRATE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('dog_percent_concentrate') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="dog_percent_concentrate_{{ $key }}" name="dog_percent_concentrate" value="{{ $key }}" {{ old('dog_percent_concentrate', $dogsOwnersAnwer->dog_percent_concentrate) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dog_candies') ? 'is-invalid' : '' }}" type="text" name="dog_candies" id="dog_candies" value="{{ old('dog_candies', $dogsOwnersAnwer->dog_candies) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dog_change_food') ? 'is-invalid' : '' }}" type="text" name="dog_change_food" id="dog_change_food" value="{{ old('dog_change_food', $dogsOwnersAnwer->dog_change_food) }}" required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('general_consultation_12') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="general_consultation_12" id="general_consultation_12" value="1" {{ $dogsOwnersAnwer->general_consultation_12 || old('general_consultation_12', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('dermatological_disease_12') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="dermatological_disease_12" id="dermatological_disease_12" value="1" {{ $dogsOwnersAnwer->dermatological_disease_12 || old('dermatological_disease_12', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('digestive_disease_12') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="digestive_disease_12" id="digestive_disease_12" value="1" {{ $dogsOwnersAnwer->digestive_disease_12 || old('digestive_disease_12', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('periodontal_disease_12') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="periodontal_disease_12" id="periodontal_disease_12" value="1" {{ $dogsOwnersAnwer->periodontal_disease_12 || old('periodontal_disease_12', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('neuro_problems_12') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="neuro_problems_12" id="neuro_problems_12" value="1" {{ $dogsOwnersAnwer->neuro_problems_12 || old('neuro_problems_12', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('metabolic_disease_12') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="metabolic_disease_12" id="metabolic_disease_12" value="1" {{ $dogsOwnersAnwer->metabolic_disease_12 || old('metabolic_disease_12', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('orthopedic_problems_12') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="orthopedic_problems_12" id="orthopedic_problems_12" value="1" {{ $dogsOwnersAnwer->orthopedic_problems_12 || old('orthopedic_problems_12', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('emergency_case_12') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="emergency_case_12" id="emergency_case_12" value="1" {{ $dogsOwnersAnwer->emergency_case_12 || old('emergency_case_12', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('other_12') ? 'is-invalid' : '' }}" type="text" name="other_12" id="other_12" value="{{ old('other_12', $dogsOwnersAnwer->other_12) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('dog_actual_disease') ? 'is-invalid' : '' }}" name="dog_actual_disease" id="dog_actual_disease">{{ old('dog_actual_disease', $dogsOwnersAnwer->dog_actual_disease) }}</textarea>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('avoid_obesity_14') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="avoid_obesity_14" id="avoid_obesity_14" value="1" {{ $dogsOwnersAnwer->avoid_obesity_14 || old('avoid_obesity_14', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('read_food_tags_14') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="read_food_tags_14" id="read_food_tags_14" value="1" {{ $dogsOwnersAnwer->read_food_tags_14 || old('read_food_tags_14', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('healthy_snacks_14') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="healthy_snacks_14" id="healthy_snacks_14" value="1" {{ $dogsOwnersAnwer->healthy_snacks_14 || old('healthy_snacks_14', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('diets_switch_14') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="diets_switch_14" id="diets_switch_14" value="1" {{ $dogsOwnersAnwer->diets_switch_14 || old('diets_switch_14', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('food_by_grow_14') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="food_by_grow_14" id="food_by_grow_14" value="1" {{ $dogsOwnersAnwer->food_by_grow_14 || old('food_by_grow_14', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('food_by_physical_14') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="food_by_physical_14" id="food_by_physical_14" value="1" {{ $dogsOwnersAnwer->food_by_physical_14 || old('food_by_physical_14', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('more_info_14') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="more_info_14" id="more_info_14" value="1" {{ $dogsOwnersAnwer->more_info_14 || old('more_info_14', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('other_14') ? 'is-invalid' : '' }}" type="text" name="other_14" id="other_14" value="{{ old('other_14', $dogsOwnersAnwer->other_14) }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\DogsOwnersAnwer::HEARD_ABOUT_PFI_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('heard_about_pfi') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="heard_about_pfi_{{ $key }}" name="heard_about_pfi" value="{{ $key }}" {{ old('heard_about_pfi', $dogsOwnersAnwer->heard_about_pfi) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ip') ? 'is-invalid' : '' }}" type="text" name="ip" id="ip" value="{{ old('ip', $dogsOwnersAnwer->ip) }}">
                @if($errors->has('ip'))
