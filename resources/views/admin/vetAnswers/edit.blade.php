...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.vetAnswer.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.vet-answers.update", [$vetAnswer->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="name">{{ trans('cruds.vetAnswer.fields.name') }}</label>
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $vetAnswer->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vet_clinic') ? 'is-invalid' : '' }}" type="text" name="vet_clinic" id="vet_clinic" value="{{ old('vet_clinic', $vetAnswer->vet_clinic) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vet_university') ? 'is-invalid' : '' }}" type="text" name="vet_university" id="vet_university" value="{{ old('vet_university', $vetAnswer->vet_university) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pet_shelters') ? 'is-invalid' : '' }}" type="text" name="pet_shelters" id="pet_shelters" value="{{ old('pet_shelters', $vetAnswer->pet_shelters) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('department') ? 'is-invalid' : '' }}" name="department_id" id="department_id" required>
                    @foreach($departments as $id => $department)
                        <option value="{{ $id }}" {{ (old('department_id') ? old('department_id') : $vetAnswer->department->id ?? '') == $id ? 'selected' : '' }}>{{ $department }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('city') ? 'is-invalid' : '' }}" name="city_id" id="city_id" required>
                    @foreach($cities as $id => $city)
                        <option value="{{ $id }}" {{ (old('city_id') ? old('city_id') : $vetAnswer->city->id ?? '') == $id ? 'selected' : '' }}>{{ $city }}</option>
                    @endforeach
                </select>
                @if($errors->has('city'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $vetAnswer->email) }}" required>
                @if($errors->has('email'))
            ...
            <div class="form-group">
                ...
                @foreach(App\VetAnswer::PET_NUTRITION_QUESTION_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('pet_nutrition_question') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="pet_nutrition_question_{{ $key }}" name="pet_nutrition_question" value="{{ $key }}" {{ old('pet_nutrition_question', $vetAnswer->pet_nutrition_question) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('recomendations_applied') ? 'is-invalid' : '' }}" type="number" name="recomendations_applied" id="recomendations_applied" value="{{ old('recomendations_applied', $vetAnswer->recomendations_applied) }}" step="1">
            ...
            <div class="form-group">
                ...
                @foreach(App\VetAnswer::PERCENT_APPLY_DIET_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('percent_apply_diet') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="percent_apply_diet_{{ $key }}" name="percent_apply_diet" value="{{ $key }}" {{ old('percent_apply_diet', $vetAnswer->percent_apply_diet) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('difficulty_change_food_owners') ? 'is-invalid' : '' }}" type="text" name="difficulty_change_food_owners" id="difficulty_change_food_owners" value="{{ old('difficulty_change_food_owners', $vetAnswer->difficulty_change_food_owners) }}" required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('obesity_5') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="obesity_5" id="obesity_5" value="1" {{ $vetAnswer->obesity_5 || old('obesity_5', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('malnutrition_5') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="malnutrition_5" id="malnutrition_5" value="1" {{ $vetAnswer->malnutrition_5 || old('malnutrition_5', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('allergies_5') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="allergies_5" id="allergies_5" value="1" {{ $vetAnswer->allergies_5 || old('allergies_5', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('gastritis_5') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="gastritis_5" id="gastritis_5" value="1" {{ $vetAnswer->gastritis_5 || old('gastritis_5', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('diarrhea_5') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="diarrhea_5" id="diarrhea_5" value="1" {{ $vetAnswer->diarrhea_5 || old('diarrhea_5', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('periodontal_5') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="periodontal_5" id="periodontal_5" value="1" {{ $vetAnswer->periodontal_5 || old('periodontal_5', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('other_disease_5') ? 'is-invalid' : '' }}" type="text" name="other_disease_5" id="other_disease_5" value="{{ old('other_disease_5', $vetAnswer->other_disease_5) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('other_5') ? 'is-invalid' : '' }}" type="text" name="other_5" id="other_5" value="{{ old('other_5', $vetAnswer->other_5) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('mix_food_6') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="mix_food_6" id="mix_food_6" value="1" {{ $vetAnswer->mix_food_6 || old('mix_food_6', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('food_outtime') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="food_outtime" id="food_outtime" value="1" {{ $vetAnswer->food_outtime || old('food_outtime', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('water_not_enough') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="water_not_enough" id="water_not_enough" value="1" {{ $vetAnswer->water_not_enough || old('water_not_enough', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('quantities_control') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="quantities_control" id="quantities_control" value="1" {{ $vetAnswer->quantities_control || old('quantities_control', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('plate_higiene') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="plate_higiene" id="plate_higiene" value="1" {{ $vetAnswer->plate_higiene || old('plate_higiene', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('other_bad_habit') ? 'is-invalid' : '' }}" type="text" name="other_bad_habit" id="other_bad_habit" value="{{ old('other_bad_habit', $vetAnswer->other_bad_habit) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('other_6') ? 'is-invalid' : '' }}" type="text" name="other_6" id="other_6" value="{{ old('other_6', $vetAnswer->other_6) }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\VetAnswer::FOOD_TYPE_RECOMMENDATION_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('food_type_recommendation') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="food_type_recommendation_{{ $key }}" name="food_type_recommendation" value="{{ $key }}" {{ old('food_type_recommendation', $vetAnswer->food_type_recommendation) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                @foreach(App\VetAnswer::FOOD_RECOMENDATION_CONCENTRATES_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('food_recomendation_concentrates') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="food_recomendation_concentrates_{{ $key }}" name="food_recomendation_concentrates" value="{{ $key }}" {{ old('food_recomendation_concentrates', $vetAnswer->food_recomendation_concentrates) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                @foreach(App\VetAnswer::PERCENT_CALORIES_CONCENTRATES_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('percent_calories_concentrates') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="percent_calories_concentrates_{{ $key }}" name="percent_calories_concentrates" value="{{ $key }}" {{ old('percent_calories_concentrates', $vetAnswer->percent_calories_concentrates) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('country_best_food') ? 'is-invalid' : '' }}" name="country_best_food" id="country_best_food" required>{{ old('country_best_food', $vetAnswer->country_best_food) }}</textarea>
            ...
            <div class="form-group">
                ...
                @foreach(App\VetAnswer::IF_US_BEST_FOOD_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('if_us_best_food') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="if_us_best_food_{{ $key }}" name="if_us_best_food" value="{{ $key }}" {{ old('if_us_best_food', $vetAnswer->if_us_best_food) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('other_11') ? 'is-invalid' : '' }}" type="text" name="other_11" id="other_11" value="{{ old('other_11', $vetAnswer->other_11) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('not_recommended_food') ? 'is-invalid' : '' }}" type="text" name="not_recommended_food" id="not_recommended_food" value="{{ old('not_recommended_food', $vetAnswer->not_recommended_food) }}" required>
            ...
            <div class="form-group">
                ...
                @foreach(App\VetAnswer::FRECUENCY_EDUCATION_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('frecuency_education') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="frecuency_education_{{ $key }}" name="frecuency_education" value="{{ $key }}" {{ old('frecuency_education', $vetAnswer->frecuency_education) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                @foreach(App\VetAnswer::HEARD_ABOUT_PFI_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('heard_about_pfi') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="heard_about_pfi_{{ $key }}" name="heard_about_pfi" value="{{ $key }}" {{ old('heard_about_pfi', $vetAnswer->heard_about_pfi) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ip') ? 'is-invalid' : '' }}" type="text" name="ip" id="ip" value="{{ old('ip', $vetAnswer->ip) }}">
                @if($errors->has('ip'))
