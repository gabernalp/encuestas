...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.prizeCode.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.prize-codes.update", [$prizeCode->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="code">{{ trans('cruds.prizeCode.fields.code') }}</label>
                <input class="form-control {{ $errors->has('code') ? 'is-invalid' : '' }}" type="text" name="code" id="code" value="{{ old('code', $prizeCode->code) }}">
                @if($errors->has('code'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('poll_name') ? 'is-invalid' : '' }}" type="text" name="poll_name" id="poll_name" value="{{ old('poll_name', $prizeCode->poll_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contestant') ? 'is-invalid' : '' }}" type="text" name="contestant" id="contestant" value="{{ old('contestant', $prizeCode->contestant) }}">
