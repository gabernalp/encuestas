...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.catsOwnersAnwer.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.cats-owners-anwers.update", [$catsOwnersAnwer->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="name">{{ trans('cruds.catsOwnersAnwer.fields.name') }}</label>
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $catsOwnersAnwer->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="text" name="email" id="email" value="{{ old('email', $catsOwnersAnwer->email) }}" required>
                @if($errors->has('email'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('department') ? 'is-invalid' : '' }}" name="department_id" id="department_id" required>
                    @foreach($departments as $id => $department)
                        <option value="{{ $id }}" {{ (old('department_id') ? old('department_id') : $catsOwnersAnwer->department->id ?? '') == $id ? 'selected' : '' }}>{{ $department }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('city') ? 'is-invalid' : '' }}" name="city_id" id="city_id" required>
                    @foreach($cities as $id => $city)
                        <option value="{{ $id }}" {{ (old('city_id') ? old('city_id') : $catsOwnersAnwer->city->id ?? '') == $id ? 'selected' : '' }}>{{ $city }}</option>
                    @endforeach
                </select>
                @if($errors->has('city'))
            ...
            <div class="form-group">
                ...
                @foreach(App\CatsOwnersAnwer::CAT_APPEAR_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('cat_appear') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="cat_appear_{{ $key }}" name="cat_appear" value="{{ $key }}" {{ old('cat_appear', $catsOwnersAnwer->cat_appear) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('other_1') ? 'is-invalid' : '' }}" type="text" name="other_1" id="other_1" value="{{ old('other_1', $catsOwnersAnwer->other_1) }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\CatsOwnersAnwer::CAT_CONSIDERATION_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('cat_consideration') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="cat_consideration_{{ $key }}" name="cat_consideration" value="{{ $key }}" {{ old('cat_consideration', $catsOwnersAnwer->cat_consideration) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('other_2') ? 'is-invalid' : '' }}" type="text" name="other_2" id="other_2" value="{{ old('other_2', $catsOwnersAnwer->other_2) }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\CatsOwnersAnwer::CAT_FOOD_ADVICE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('cat_food_advice') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="cat_food_advice_{{ $key }}" name="cat_food_advice" value="{{ $key }}" {{ old('cat_food_advice', $catsOwnersAnwer->cat_food_advice) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                @foreach(App\CatsOwnersAnwer::CAT_FOOD_CHOOSE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('cat_food_choose') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="cat_food_choose_{{ $key }}" name="cat_food_choose" value="{{ $key }}" {{ old('cat_food_choose', $catsOwnersAnwer->cat_food_choose) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('other_4') ? 'is-invalid' : '' }}" type="text" name="other_4" id="other_4" value="{{ old('other_4', $catsOwnersAnwer->other_4) }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\CatsOwnersAnwer::CAT_DIFF_NUTRITION_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('cat_diff_nutrition') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="cat_diff_nutrition_{{ $key }}" name="cat_diff_nutrition" value="{{ $key }}" {{ old('cat_diff_nutrition', $catsOwnersAnwer->cat_diff_nutrition) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                @foreach(App\CatsOwnersAnwer::CAT_DIET_OWNER_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('cat_diet_owner') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="cat_diet_owner_{{ $key }}" name="cat_diet_owner" value="{{ $key }}" {{ old('cat_diet_owner', $catsOwnersAnwer->cat_diet_owner) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                @foreach(App\CatsOwnersAnwer::CAT_FOOD_TYPE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('cat_food_type') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="cat_food_type_{{ $key }}" name="cat_food_type" value="{{ $key }}" {{ old('cat_food_type', $catsOwnersAnwer->cat_food_type) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('diamond_naturals_8') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="diamond_naturals_8" id="diamond_naturals_8" value="1" {{ $catsOwnersAnwer->diamond_naturals_8 || old('diamond_naturals_8', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('purina_8') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="purina_8" id="purina_8" value="1" {{ $catsOwnersAnwer->purina_8 || old('purina_8', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('mars_8') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="mars_8" id="mars_8" value="1" {{ $catsOwnersAnwer->mars_8 || old('mars_8', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('whiskas_8') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="whiskas_8" id="whiskas_8" value="1" {{ $catsOwnersAnwer->whiskas_8 || old('whiskas_8', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('other_8') ? 'is-invalid' : '' }}" type="text" name="other_8" id="other_8" value="{{ old('other_8', $catsOwnersAnwer->other_8) }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\CatsOwnersAnwer::CAT_PERCENT_CONCENTRATE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('cat_percent_concentrate') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="cat_percent_concentrate_{{ $key }}" name="cat_percent_concentrate" value="{{ $key }}" {{ old('cat_percent_concentrate', $catsOwnersAnwer->cat_percent_concentrate) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cat_candies') ? 'is-invalid' : '' }}" type="text" name="cat_candies" id="cat_candies" value="{{ old('cat_candies', $catsOwnersAnwer->cat_candies) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cat_change_food') ? 'is-invalid' : '' }}" type="text" name="cat_change_food" id="cat_change_food" value="{{ old('cat_change_food', $catsOwnersAnwer->cat_change_food) }}" required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('general_consultation_12') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="general_consultation_12" id="general_consultation_12" value="1" {{ $catsOwnersAnwer->general_consultation_12 || old('general_consultation_12', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('dermatological_disease_12') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="dermatological_disease_12" id="dermatological_disease_12" value="1" {{ $catsOwnersAnwer->dermatological_disease_12 || old('dermatological_disease_12', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('digestive_disease_12') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="digestive_disease_12" id="digestive_disease_12" value="1" {{ $catsOwnersAnwer->digestive_disease_12 || old('digestive_disease_12', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('periodontal_disease_12') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="periodontal_disease_12" id="periodontal_disease_12" value="1" {{ $catsOwnersAnwer->periodontal_disease_12 || old('periodontal_disease_12', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('neuro_problems_12') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="neuro_problems_12" id="neuro_problems_12" value="1" {{ $catsOwnersAnwer->neuro_problems_12 || old('neuro_problems_12', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('metabolic_disease_12') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="metabolic_disease_12" id="metabolic_disease_12" value="1" {{ $catsOwnersAnwer->metabolic_disease_12 || old('metabolic_disease_12', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('orthopedic_problems_12') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="orthopedic_problems_12" id="orthopedic_problems_12" value="1" {{ $catsOwnersAnwer->orthopedic_problems_12 || old('orthopedic_problems_12', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('emergency_case_12') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="emergency_case_12" id="emergency_case_12" value="1" {{ $catsOwnersAnwer->emergency_case_12 || old('emergency_case_12', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('other_12') ? 'is-invalid' : '' }}" type="text" name="other_12" id="other_12" value="{{ old('other_12', $catsOwnersAnwer->other_12) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('cat_actual_disease') ? 'is-invalid' : '' }}" name="cat_actual_disease" id="cat_actual_disease">{{ old('cat_actual_disease', $catsOwnersAnwer->cat_actual_disease) }}</textarea>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('avoid_obesity_14') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="avoid_obesity_14" id="avoid_obesity_14" value="1" {{ $catsOwnersAnwer->avoid_obesity_14 || old('avoid_obesity_14', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('read_food_tags_14') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="read_food_tags_14" id="read_food_tags_14" value="1" {{ $catsOwnersAnwer->read_food_tags_14 || old('read_food_tags_14', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('healthy_snacks_14') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="healthy_snacks_14" id="healthy_snacks_14" value="1" {{ $catsOwnersAnwer->healthy_snacks_14 || old('healthy_snacks_14', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('diets_switch_14') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="diets_switch_14" id="diets_switch_14" value="1" {{ $catsOwnersAnwer->diets_switch_14 || old('diets_switch_14', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('food_by_grow_14') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="food_by_grow_14" id="food_by_grow_14" value="1" {{ $catsOwnersAnwer->food_by_grow_14 || old('food_by_grow_14', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('food_by_physical_14') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="food_by_physical_14" id="food_by_physical_14" value="1" {{ $catsOwnersAnwer->food_by_physical_14 || old('food_by_physical_14', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('more_info_14') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="more_info_14" id="more_info_14" value="1" {{ $catsOwnersAnwer->more_info_14 || old('more_info_14', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('other_14') ? 'is-invalid' : '' }}" type="text" name="other_14" id="other_14" value="{{ old('other_14', $catsOwnersAnwer->other_14) }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\CatsOwnersAnwer::HEARD_ABOUT_PFI_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('heard_about_pfi') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="heard_about_pfi_{{ $key }}" name="heard_about_pfi" value="{{ $key }}" {{ old('heard_about_pfi', $catsOwnersAnwer->heard_about_pfi) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ip') ? 'is-invalid' : '' }}" type="text" name="ip" id="ip" value="{{ old('ip', $catsOwnersAnwer->ip) }}">
                @if($errors->has('ip'))
